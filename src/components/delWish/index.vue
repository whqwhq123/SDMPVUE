<template>
    <div class="page">
      ...
      <div class="card-xfsp-content" v-if="cjyy">
          <div class="card-text-group">
              <div class="card-text" v-for="(item, i) in cjyy.array" v-if="i < 4" :key="i">
          ...
          <div class="card-img-line">
              ...
              <img :src="imageApi+'/line_liner.png'" alt="">
          </div>
      ...
      <div class="del_detail">
          <a hover-class="none" :href="serviceHref['cjyy']">解读详情</a>
      </div>
      <div class="line"></div>
       <div class="del_wish">
        消费水平
      </div>
      <div class="card-xfsp-content" v-if="xfsp">
          <div class="card-text-group">
          ...
          <div class="card-img-line">
              ...
              <img :src="imageApi+'/cus_level.png'" alt="">
          </div>
          <div class="card-num-group">
      ...
      <div class="del_detail">
          <a hover-class="none" :href="serviceHref['xfsp']">解读详情</a>
      </div>
      <div class="line"></div>
      <div class="del_wish">
        性格画像
    ...
    <div class="card-xghx-content">
        ...
        <div class="card-tag tag-4">{{ xghx ? xghx.xghx[3] : '' }}</div>
        <div class="card-tag tag-5">{{ xghx ? xghx.xghx[4] : '' }}</div>
        <div class="card-tag tag-6">{{ xghx ? xghx.xghx[5] : '' }}</div>
        <div class="card-tag tag-7">{{ xghx ? xghx.xghx[6] : '' }}</div>
    </div>
     <div class="text_disc">
      ...
      async insightCustomerFun () {
        try {
          ...
          let res = await this.insightCustomer({
            phone: 15600018919||this.userInfo.phone,
