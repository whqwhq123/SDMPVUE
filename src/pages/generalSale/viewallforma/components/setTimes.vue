<template>
    <div>
        <picker mode="multiSelector" v-model="dateTime1" @change="changeDateTime1" bindcolumnchange="changeDateTimeColumn1" :range="dateTimeArray1">
            <view class="text">
...
<script>
import { dateTimePicker } from "../js/dateTimePicker.js";
    export default {
        data () {
            return {
                dateTimeArray1: null,
